    ...
    return (
        <div className='main-container'>
            <div className='product-container'>
                ...
                <img className="product-pic" src="/productPage/product1.png" alt="product image" />
                <div className='info-container'>
                    ...
                    <div className='product-pic-suggestion-container'>
                        <img className="product-pic-suggestion" src="/productPage/product2.png" alt="product image2" />
                        <img className="product-pic-suggestion" src="/productPage/product3.png" alt="product image3" />
                        <img className="product-pic-suggestion" src="/productPage/product4.png" alt="product image4" />
                        <img className="product-pic-suggestion" src="/productPage/product5.png" alt="product image5" />
                    </div>
                </div>
            </div>
        </div>
